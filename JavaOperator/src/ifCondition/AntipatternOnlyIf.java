...
public class AntipatternOnlyIf {
	public static void main(String[] args) {
		/*
		 * 구문 (statement) 자바 연산식에서 3가지 종류의 구문으로 나뉜다. 1.조건문 if, if-else, swhich
		 * 2.반복문 while, do while, for 3.기타구문 continue,break ,return
		 */
		int x = 1, y = 2; // 지변 초기화
		if (x == y) {// 숫자값의 비교 연산자 ==
 ...
 * 코딩되어야 한다. 따라서 only if 문을 코딩할 때는 개발자가 단 한가지 케이스만 출력할 것이라는 확신이 있을 때 다룬다.
 * */
